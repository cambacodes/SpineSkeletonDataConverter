    ...
    for (const auto& [slotName, slotMap] : skin.attachments) {
        ...
        for (const auto& [attachmentName, attachment] : slotMap) {
            ...
            switch (attachment.type) {
                ...
                default:
                    throw std::runtime_error("Unsupported Spine 3.3 attachment type");
            }
        }
    }
}
        ...
        for (const auto& [timelineName, timeline] : multiTimeline) {
            ...
            switch (timelineType) {
                ...
                case SlotTimelineType::SLOT_RGB:
                    ...
                    break;
                default:
                    throw std::runtime_error("Unsupported Spine 3.3 slot timeline type");
            }
        ...
        for (const auto& [timelineName, timeline] : multiTimeline) {
            ...
            switch (timelineType) {
                ...
                case BONE_SHEARY:
                    ...
                    break;
                default:
                    throw std::runtime_error("Unsupported Spine 3.3 bone timeline type");
            }
            writeVarint(binary, timeline.size(), true);
            switch (timelineType) {
                case BONE_ROTATE: {
